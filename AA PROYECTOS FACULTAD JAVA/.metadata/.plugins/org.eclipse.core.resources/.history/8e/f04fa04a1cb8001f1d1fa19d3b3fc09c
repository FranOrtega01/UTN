...
<script>
    function handleForm() {
        ...
        if (txtId === "") {
            document.getElementById("error-txtId").textContent = "El ID del cliente debe ser un número y no puede estar vacío.";
            valido = false;
        }
        ...
        if (txtCbu.value.trim() === "") {
        	...
        	document.getElementById("error-txtCbu").textContent = "El CBU debe tener 22 números.";
            valido = false;
        }
