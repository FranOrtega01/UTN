...
<script>
    function handleForm() {
        ...
        if (!monto.value.trim()) {
            ...
            errorMonto.textContent = "El monto debe ser un número positivo de hasta 2 decimales.";
            valido = false;
        ...
        if (!cbu.value.trim()) {
            ...
            errorCbu.textContent = "El CBU debe tener 22 dígitos.";
            valido = false;
        } else {
        ...
        if (!detalle.value.trim()) {
            ...
            errorDetalle.textContent = "El detalle no puede tener más de 20 caracteres.";
            valido = false;
        } else {
